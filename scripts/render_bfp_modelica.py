...
def main() -> int:
    ...
    parser.add_argument("--trip-time", type=finite_float, default=600.0)
    parser.add_argument("--coastdown-duration", type=finite_float, default=5.0)
    parser.add_argument("--stop-time", type=finite_float, default=1000.0)
    parser.add_argument("--intervals", type=int, default=10_000)
    parser.add_argument("--final-rpm", type=finite_float, default=700.0)
