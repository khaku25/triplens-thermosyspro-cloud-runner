...
find_library(OPENMODELICA_SIMULATION_RUNTIME
             NAMES SimulationRuntimeC
             PATHS ${OPENMODELICA_RUNTIME_DIRECTORY}
             NO_DEFAULT_PATH)
if(NOT OPENMODELICA_SIMULATION_RUNTIME)
  message(FATAL_ERROR "Full OpenModelica SimulationRuntimeC was not found")
endif()
target_link_libraries(${FMU_NAME_HASH} PRIVATE ${OPENMODELICA_SIMULATION_RUNTIME})"""
MINIMAL_DEFINITIONS = (
