...
simulate(
  ...
  method="dassl",
  outputFormat="csv",
  // Legacy ThermoSysPro produces a large initialization system without a
  // usable sparse Jacobian pattern. Force OpenModelica's documented dense
  // nonlinear path instead of the automatic KINSOL/KLU sparse path.
