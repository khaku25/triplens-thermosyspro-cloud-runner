within ;
model TripLens_RegularizedStodolaTurbine "Multistage turbine group using Stodola's ellipse"
...
public
  ...
  Real pressureSquareDifference;
  Real regularizedPressureSquare;
...
"));
end TripLens_RegularizedStodolaTurbine;
