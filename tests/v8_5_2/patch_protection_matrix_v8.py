...
# V8.5.3's current model already carries the stroke-based regularizer.  Keep
# the patcher idempotent against that newer implementation while retaining the
# legacy V8.7 insertion path for a pristine V7 predecessor.
DRUM_VALVE_REGULARIZATION_MARKER = "TRIPLENS_DRUM_FAULT_STROKE_V8_8"
REQUIRED_MARKERS = (
