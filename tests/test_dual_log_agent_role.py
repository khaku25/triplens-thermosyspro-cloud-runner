...
RAW_FIELDS=['record_sequence','session_id','incident_id','model_time_s','wall_time_utc','collector_quality','vppLPFWPTripCommandNative','vppLPFWPTripLatchNative','vppVCBA02TripCommandNative','vppECMSVCBA02Closed','vppLPFWPSpeedRPM','vppLPFWPMassFlowTH','vppLPDrumLevelM']
