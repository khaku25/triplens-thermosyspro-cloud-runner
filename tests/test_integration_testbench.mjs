...
test('evidence detail exposes both tag and registered logic diagram targets', () => {
...
test('current analysis state is adapted to report v2 without losing edits or evidence', () => {
  ...
  const events=[{event_id:'E-1',evidence_id:'E-1',model_time_s:48.44,message:'GT TRIP LATCH ACTIVE',source_node:'vppGTTripLatch',tag:'TRIP_LATCH',source:'DCS'}];
