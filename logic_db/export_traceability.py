...
def main():
    ...
    try:
        ...
        db.close()
    if payload["summary"]["active_logic"] != 538:
        raise ValueError("Trace viewer must use the 538-row active logic scope")
